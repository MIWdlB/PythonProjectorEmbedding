...
def spade_partition():
    ...
    def internal(pyscf_mf, active_atoms=None, c_occ=None, n_act_mos=None):
        ...
        if isinstance(c_occ, tuple):
            ...
            alpha_active, alpha_inactive = internal(pyscf_mf, active_atoms, c_occ=c_occ[0], n_act_mos=n_act_mos_a)
            beta_active, beta_inactive = internal(pyscf_mf, active_atoms, c_occ=c_occ[1], n_act_mos=n_act_mos_b)
            return (alpha_active, beta_active), (alpha_inactive, beta_inactive)
